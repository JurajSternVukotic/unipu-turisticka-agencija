...
VALUES 
    ...
    (40, 'European Delights', 'Embark on a journey through the enchanting cities of Europe and experience their unique charms. Immerse yourself in the rich history, indulge in local cuisine, and marvel at iconic landmarks. Discover the best of Zagreb, Dubrovnik, Prague, Paris, and Barcelona.', 6, 12, 4, 1500.00),
    (41, 'Coastal Explorer', 'Discover the coastal treasures of Zadar, Rijeka, Sydney, Lisbon, and Miami. Relax on pristine beaches, explore vibrant waterfronts, and indulge in delicious seafood. Experience the best of both worlds: sun-soaked relaxation and cultural exploration.', 4, 10, 7, 800.00),
    (42, 'Metropolis Tour', 'Embark on a cosmopolitan adventure through the bustling cities of New York, Tokyo, London, Moscow, and Istanbul. Explore iconic landmarks, immerse yourself in diverse cultures, and indulge in world-class shopping and dining. Experience the vibrant energy of these global metropolises.', 6, 16, 3, 2000.00),
    (43, 'Historical Gems', 'Uncover the historical gems of Rome, Jerusalem, Berlin, Hiroshima, and Warsaw. Explore ancient ruins, visit sacred sites, and learn about the significant events that shaped these cities. Immerse yourself in the rich history and heritage of these destinations.', 4, 12, 2, 1200.00),
    (44, 'Urban Escape', 'Escape to the urban jungles of Singapore, Madrid, Beijing, Buenos Aires, and Prague. Immerse yourself in the vibrant city life, explore modern architecture, and savor diverse culinary delights. Experience the fusion of tradition and innovation.', 8, 14, 11, 1800.00),
    (45, 'Island Paradise', 'Embark on an island-hopping adventure in Dubrovnik, Šibenik, Ibiza, Sydney, and Porto. Discover pristine beaches, crystal-clear waters, and breathtaking landscapes. Relax, unwind, and experience the ultimate island paradise.', 2, 8, 5, 1000.00),
    (46, 'Cultural Fusion', 'Immerse yourself in the cultural fusion of Toronto, Lisbon, Tel Aviv, Oslo, and Milan. Explore diverse neighborhoods, experience multicultural events, and indulge in a blend of international cuisines. Celebrate diversity and discover hidden gems.', 6, 12, 8, 1500.00),
    (47, 'Nature Retreat', 'Escape to the tranquility of Oslo, Hiroshima, Graz, Sydney, and Porto. Immerse yourself in the beauty of nature, explore scenic landscapes, and engage in outdoor activities. Rejuvenate your soul and find serenity amidst stunning natural settings.', 4, 10, 5, 1200.00),
    (48, 'Adventure Quest', 'Embark on an adrenaline-pumping adventure in Dubrovnik, New York, Tokyo, Barcelona, and Buenos Aires. Experience thrilling activities such as zip-lining, bungee jumping, and hiking. Challenge yourself and create unforgettable memories.', 6, 16, 14, 2000.00),
    (49, 'Romantic Getaway', 'Indulge in a romantic escape in Dubrovnik, Paris, Venice, Lisbon, and Sydney. Experience enchanting sunsets, stroll hand-in-hand through charming streets, and savor intimate dining experiences. Ignite the sparks of romance and create timeless memories.', 2, 6, 4, 1200.00),
    (50, 'Croatian Tour', 'Embark on an unforgettable journey through Croatia with our Croatian Tour package. Explore the vibrant capital city of Zagreb, soak up the rich cultural heritage in Osijek, discover the coastal charm of Rijeka, and immerse yourself in the ancient history of Pula. From the bustling city streets to the picturesque coastlines, this tour offers a perfect blend of cultural experiences and natural beauty. Grab this opportunity to create lasting memories.', 2, 10, 0, 800.00);
